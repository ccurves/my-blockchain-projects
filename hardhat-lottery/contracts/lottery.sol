...
error Lottery__InsufficentETHEntered();
 ...
 * @dev This implements the Chainlink VRF v2 and Chainlink Automations
 */
contract Lottery is VRFConsumerBaseV2, AutomationCompatibleInterface {
    ...
    function enterLottery() public payable {
        if (msg.value < i_entranceFee) {
            revert Lottery__InsufficentETHEntered();
        }
    ...
    function fulfillRandomWords(
        ...
        address payable recentWinner = s_players[indexedOfWinnner];
